...
Once you have your world's JSON file, you need to copy it into your browser. This JSON file will be likely be very large (~112 MB for a 256x64x256 world). Open the file in a text editor that supports large files, select all text (CTRL + A), and copy it (CTRL + C).
